...
namespace Tulip
{
    ...
    internal static class DecimalMath
    {
        ...
        public static decimal Atan(decimal x)
        {
            ...
            switch (x)
            {
                case Decimal.Zero: result = Decimal.Zero; break;
                case Decimal.One: result = PIdiv4; break;
                default: result = Asin(x / Sqrt(Decimal.One + x * x)); break;
            }
            return result;
            /*return x switch
            {
        ...
        public static decimal Acos(decimal x)
        {
            ...
            switch (x)
            {
                case Decimal.Zero: result = PIdiv2; break;
                case Decimal.One: result = Decimal.Zero; break;
                default: result = (x < Decimal.Zero ? PI - Acos(-x) : PIdiv2 - Asin(x)); break;
            }
            return result;
            /*return x switch
            {
        ...
        public static decimal Atan2(decimal y, decimal x)
        {
            ...
            decimal result;
            if (y > Decimal.Zero) result = PIdiv2;
            else if (y < Decimal.Zero) result = -PIdiv2;
            else throw new ArgumentException("invalid atan2 arguments");
            return result;
            /*return x switch
            {
